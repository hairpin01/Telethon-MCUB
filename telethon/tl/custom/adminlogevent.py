...
class AdminLogEvent:
    ...
    def changed_about(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeAbout)
    ...
    def changed_title(self):
        ...
        If `True`, `old` and `new` will be present as `str`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeTitle)
    ...
    def changed_username(self):
        ...
        If `True`, `old` and `new` will be present as `str`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeUsername)
    ...
    def changed_photo(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangePhoto)
    ...
    def changed_sticker_set(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeStickerSet)
    ...
    def changed_message(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionEditMessage)
    ...
    def deleted_message(self):
        ...
        `Message <telethon.tl.custom.message.Message>`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionDeleteMessage)
    ...
    def changed_invites(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionToggleInvites)
    ...
    def changed_location(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeLocation)
    ...
    def joined(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantJoin)
    ...
    def joined_invite(self):
        ...
        :tl:`ChannelParticipant`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantInvite)
    ...
    def left(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantLeave)
    ...
    def changed_signatures(self):
        ...
        If `True`, `old` and `new` will be present as `bool`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionToggleSignatures)
    ...
    def changed_pin(self):
        ...
        `Message <telethon.tl.custom.message.Message>`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionUpdatePinned)
    ...
    def changed_default_banned_rights(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionDefaultBannedRights)
    ...
    def stopped_poll(self):
        ...
        `Message <telethon.tl.custom.message.Message>`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionStopPoll)
    ...
    def started_group_call(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionStartGroupCall)
    ...
    def discarded_group_call(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionDiscardGroupCall)
    ...
    def user_muted(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantMute)
    ...
    def user_unmutted(self):
        ...
        If `True`, `new` will be present as :tl:`GroupCallParticipant`.
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantUnmute)
    ...
    def changed_history_ttl(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionChangeHistoryTTL)
    ...
    def edited_exported_invite(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionExportedInviteEdit)
    ...
    def joined_by_invite(self):
        ...
        """
        return isinstance(
            self.original.action, types.ChannelAdminLogEventActionParticipantJoinByInvite
        )
    ...
    def changed_user_volume(self):
        ...
        """
        return isinstance(self.original.action, types.ChannelAdminLogEventActionParticipantVolume)
